...
const mask = () => {
    if(document.getElementById('phoneMask')){
        const phoneMask = IMask(document.getElementById("phoneMask"), {
            mask: "+{7}(000)000-00-00",
        });
    
        phoneMask.on("accept", () => {
            const value = phoneMask.value;
            document.getElementById("phoneMask").value = value;
...
//         <input class="popup__input" type="text" placeholder="Ваш username в Facebook" required="">
//     </div>
// `;
